...
module.exports = function (app, auth) {
	...
	// Alarm page
	app.get('/arlozorov/alarm', auth.isAuthenticated([aps.id]), function(req, res){
	...
	// Silomat page
	app.get('/arlozorov/silomat', auth.isAuthenticated([aps.id]), function(req, res){
		res.render('aps/arlozorov/silomat', {
			title: 'Arlozorov: Silomat',
			nav_active: 2,
			ng_app: 'deviceApp',
			ng_controller: 'deviceCtrl'
		});
	...
	// Virtual Garage page
	app.get('/arlozorov/garage', auth.isAuthenticated([aps.id]), function(req, res){
		res.render('aps/arlozorov/garage', {
			title: 'Arlozorov: Silomat',
			nav_active: 2,
			ng_app: 'deviceApp',
			ng_controller: 'deviceCtrl'
	...
	// Plc Comm
	app.get('/arlozorov/plc/comm', auth.isAuthenticated([aps.id]), function(req, res){
		res.render('aps/arlozorov/plc_comm', {
			title: 'Arlozorov: Plc Comm',
			nav_active: 8,
			tab_active: 0,
			ng_app: 'commApp',
			ng_controller: 'commCtrl'
		});
	});
	// Plc I/O List view
	app.get('/arlozorov/plc/io/list', auth.isAuthenticated([aps.id]), function(req, res){
		res.render('aps/arlozorov/plc_io_list', {
	...
	// Plc I/O Graphic view
	app.get('/arlozorov/plc/io/graph', auth.isAuthenticated([aps.id]), function(req, res){
		res.render('aps/arlozorov/plc_io_graph', {
			title: 'Arlozorov: Plc I/O',
			nav_active: 8,
			tab_active: 1,
			ng_app: 'ioApp',
