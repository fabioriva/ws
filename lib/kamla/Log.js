...
exports.historyLog = function (data, done) {
	...
	db.query('INSERT INTO t_history SET ?', post, function(err, res) {
		...
		historyLogMsg(res.insertId, post, function (log) {
			...
			//console.log('(1)', log);
			//console.log('(2)', ws_log);			
			//console.log('(3)', JSON.stringify(ws_log));
			var html = '';
...
function historyLogMsg(id, msg, done) {
