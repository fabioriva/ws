...
var wsdata = new Client (plc, plc.conn_1, 'kamla_left:tasks:data');
...
var wsmap = new Client (plc, plc.conn_2, 'kamla_left:tasks:map');
...
var sio_statistics = sio
	...
	.on('connection', function (socket) {
		...
		statistics.operationDaily(db, 1, null, function(data) {
