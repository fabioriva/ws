...
exports.readDevices = function (byteIni, byteLen, data) {
	...
	// Exit Queue
	d.exit_queue[0].card = utility.BytesToInt(data[80], data[81]);
	d.exit_queue[1].card = utility.BytesToInt(data[82], data[83]);
	d.exit_queue[2].card = utility.BytesToInt(data[84], data[85]);
	d.exit_queue[3].card = utility.BytesToInt(data[86], data[87]);
	d.exit_queue[4].card = utility.BytesToInt(data[88], data[89]);
	
	d.exit_queue[5].card = utility.BytesToInt(data[90], data[91]);
	d.exit_queue[6].card = utility.BytesToInt(data[92], data[93]);
	d.exit_queue[7].card = utility.BytesToInt(data[94], data[95]);
	d.exit_queue[8].card = utility.BytesToInt(data[96], data[97]);
	d.exit_queue[9].card = utility.BytesToInt(data[98], data[99]);
