...
// Total length (DB430)
var LEN_DATA = 540;//LEN_DEVICE + LEN_AL + LEN_IO;
...
wsdata.on('recv', function(data) {
	...
	var devices = ws_device.readDevices(INI_DEVICE, LEN_DEVICE, data.s7)
	sio.of('/devices').emit('devices:refresh', { devices: JSON.stringify(devices) });
	
	/* Alarms : Elevator */
	var al_01 = el1.sendAlarms(el1.setAlarms(260, AL_OFFSET, data.s7, el1.alarms));
	var al_02 = el2.sendAlarms(el2.setAlarms(264, AL_OFFSET, data.s7, el2.alarms));
	var al_03 = el3.sendAlarms(el3.setAlarms(268, AL_OFFSET, data.s7, el3.alarms));
	var al_04 = el4.sendAlarms(el4.setAlarms(272, AL_OFFSET, data.s7, el4.alarms));	
	var alarms_el = [al_01, al_02, al_03, al_04];
	sio.of('/ws/alarm').emit('refresh:alarms', { alarms: alarms_el });
	/* Alarms : Shuttle */
	var al_11 = sh1.sendAlarms(sh1.setAlarms(276, AL_OFFSET, data.s7, sh1.alarms));
	var al_12 = sh2.sendAlarms(sh2.setAlarms(280, AL_OFFSET, data.s7, sh2.alarms));
	var al_13 = sh3.sendAlarms(sh3.setAlarms(284, AL_OFFSET, data.s7, sh3.alarms));
	var al_14 = sh4.sendAlarms(sh4.setAlarms(288, AL_OFFSET, data.s7, sh4.alarms));
	var al_15 = sh5.sendAlarms(sh5.setAlarms(292, AL_OFFSET, data.s7, sh5.alarms));
	var al_16 = sh6.sendAlarms(sh6.setAlarms(296, AL_OFFSET, data.s7, sh6.alarms));
	var al_17 = sh7.sendAlarms(sh7.setAlarms(300, AL_OFFSET, data.s7, sh7.alarms));
	var al_18 = sh8.sendAlarms(sh8.setAlarms(304, AL_OFFSET, data.s7, sh8.alarms));
	var alarms_sh = [al_11, al_12, al_13, al_14, al_15, al_16, al_17, al_18];
	sio.of('/ws/alarm').emit('refresh:alarms', { alarms: alarms_sh });
	/* Alarms : Cabin */
	var al_21 = eu1.sendAlarms(eu1.setAlarms(308, AL_OFFSET, data.s7, eu1.alarms));
	var al_22 = eu2.sendAlarms(eu2.setAlarms(312, AL_OFFSET, data.s7, eu2.alarms));
	var al_23 = eu3.sendAlarms(eu3.setAlarms(316, AL_OFFSET, data.s7, eu3.alarms));	
	var alarms_eu = [al_21, al_22, al_23];
	sio.of('/ws/alarm').emit('refresh:alarms', { alarms: alarms_eu });

	/* I/O Elevator */
	var io01 = ws_io.readIo(320, 10, data.s7, ws_io.Rack_el_1);
	var io02 = ws_io.readIo(330, 10, data.s7, ws_io.Rack_el_2);
	var io03 = ws_io.readIo(340, 10, data.s7, ws_io.Rack_el_3);
	var io04 = ws_io.readIo(350, 10, data.s7, ws_io.Rack_el_4);
	var racks_el = [io01, io02, io03, io04];
	sio.of('/plc_io').emit('refresh:plcio_el', { plcio: racks_el });
	
	/* I/O Shuttle */
	var io11 = ws_io.readIo(360, 7, data.s7, ws_io.Rack_sh_1);
	var io12 = ws_io.readIo(367, 4, data.s7, ws_io.Rack_sh_2);
	sio.of('/plc_io_sh').emit('refresh:plcio_sh_01', { plcio: [io11, io12] })	
	var io21 = ws_io.readIo(372, 7, data.s7, ws_io.Rack_sh_1);
	var io22 = ws_io.readIo(379, 4, data.s7, ws_io.Rack_sh_2);
	sio.of('/plc_io_sh').emit('refresh:plcio_sh_02', { plcio: [io21, io22] })
	var io31 = ws_io.readIo(384, 7, data.s7, ws_io.Rack_sh_1);
	var io32 = ws_io.readIo(391, 4, data.s7, ws_io.Rack_sh_2);
	sio.of('/plc_io_sh').emit('refresh:plcio_sh_03', { plcio: [io31, io32] })
	var io41 = ws_io.readIo(396, 7, data.s7, ws_io.Rack_sh_1);
	var io42 = ws_io.readIo(403, 4, data.s7, ws_io.Rack_sh_2);
	sio.of('/plc_io_sh').emit('refresh:plcio_sh_04', { plcio: [io41, io42] })
	var io51 = ws_io.readIo(408, 7, data.s7, ws_io.Rack_sh_1);
	var io52 = ws_io.readIo(415, 4, data.s7, ws_io.Rack_sh_2);
	sio.of('/plc_io_sh').emit('refresh:plcio_sh_05', { plcio: [io51, io52] })
	var io61 = ws_io.readIo(420, 7, data.s7, ws_io.Rack_sh_1);
	var io62 = ws_io.readIo(427, 4, data.s7, ws_io.Rack_sh_2);
	sio.of('/plc_io_sh').emit('refresh:plcio_sh_06', { plcio: [io61, io62] })
	var io71 = ws_io.readIo(432, 7, data.s7, ws_io.Rack_sh_1);
	var io72 = ws_io.readIo(439, 4, data.s7, ws_io.Rack_sh_2);
	sio.of('/plc_io_sh').emit('refresh:plcio_sh_07', { plcio: [io71, io72] })
	var io81 = ws_io.readIo(444, 7, data.s7, ws_io.Rack_sh_1);
	var io82 = ws_io.readIo(451, 4, data.s7, ws_io.Rack_sh_2);
	...
	/* I/O Cabin */
	var io_eu_11 = ws_io.readIo(456, 7, data.s7, ws_io.Rack_eu_1);
	var io_eu_12 = ws_io.readIo(463, 4, data.s7, ws_io.Rack_eu_2);
	var io_eu_13 = ws_io.readIo(467, 10, data.s7, ws_io.Rack_eu_3);
	var io_eu_14 = ws_io.readIo(477, 6, data.s7, ws_io.Rack_eu_4);
	sio.of('/plc_io_eu').emit('refresh:plcio_eu_01', { plcio: [io_eu_11, io_eu_12, io_eu_13, io_eu_14] })
	var io_eu_21 = ws_io.readIo(484, 7, data.s7, ws_io.Rack_eu_1);
	var io_eu_22 = ws_io.readIo(491, 4, data.s7, ws_io.Rack_eu_2);
	var io_eu_23 = ws_io.readIo(495, 10, data.s7, ws_io.Rack_eu_3);
	var io_eu_24 = ws_io.readIo(505, 6, data.s7, ws_io.Rack_eu_4);
	sio.of('/plc_io_eu').emit('refresh:plcio_eu_02', { plcio: [io_eu_21, io_eu_22, io_eu_23, io_eu_24] })
	var io_eu_31 = ws_io.readIo(512, 7, data.s7, ws_io.Rack_eu_1);
	var io_eu_32 = ws_io.readIo(519, 4, data.s7, ws_io.Rack_eu_2);
	var io_eu_33 = ws_io.readIo(523, 10, data.s7, ws_io.Rack_eu_3);
	var io_eu_34 = ws_io.readIo(533, 6, data.s7, ws_io.Rack_eu_4);
...
wsmap.on('recv', function(data) {
	...
	switch (data.rq) {
		...
		case 'map:statistics':
			...
			sio.of('/map/statistics').socket(data.id).emit(data.rq, { map: JSON.stringify(statistics) });
			break;
	}
	...
	switch (op) {
		...
		case 96 :
			...
			/*var msg = {
				id : 'dummy_sio_id',
				rq : 'map:read',
				s7 : s7Msg(READ, 'D', 440, 2, LEN_MAP, 0, 0)
			};
...
var sio_devices = sio
	...
	.on('connection', function (socket) {
		...
		socket.emit('devices:paint', {
			devices: JSON.stringify(ws_device.Devices)
		});
		
		socket.on('devices:exit', function (data) {
			var o = JSON.parse(data.data);
			//console.log('Exit card ' + o.value);
			var msg = {
				id : socket.id,
				rq : 'devices:exit',
				s7 : s7Msg(0x75, 'D', 430, 0, LEN_DATA, o.nr, o.value)
			}
			wsdata.enqueueMsg(msg);
		});
...
var sio_map = sio
	...
	.on('connection', function (socket) {
		...
		socket.emit('map:paint', {
			map: JSON.stringify(ws_map.MapSizes)
		});
		...
		socket.on('map:read', function (data) {
			switch (data.level) {
				...
				default:
					...
					id : socket.id,
					rq : 'map:read',
					s7 : s7Msg(0x72, 'D', 440, 2, 2048, 0, 0)
					}
					wsmap.enqueueMsg(msg);
					break;
		...
		socket.on('map:edit', function (data) {
			...
			var msg = {
				id : socket.id,
				rq : 'map:edit',
				s7 : s7Msg(0x6d, 'D', 440, 2, 2048, o.nr, o.value)
			}
			wsmap.enqueueMsg(msg);
		});
