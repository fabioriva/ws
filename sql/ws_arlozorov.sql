...
(2, 'Vertical laser value out of range'),
(3, 'Hoisting speed check'),
(4, 'Hoisting inverter trip'),
(5, 'Hoisting software speed check'),
(6, 'Hoisting feedback check'),
(7, 'Elevator locking pin motor time out'),
(8, 'Elevator locking pin limitswitches'),
(9, 'Cable-reel drum check'),
(10, 'Shuttle rotation motor time out'),
(11, 'Rotation encoder value out of range'),
(12, 'Rotation inverter trip'),
(13, 'Rotation locking pin motor time out'),
(14, 'Rotation locking pin limitswitches'),
(15, 'Thermic motor protection check ( Main Panel )'),
(16, 'Thermic motor protection check ( Elevator Panel )'),
(17, ''),
(18, ''),
(19, ''),
(20, ''),
...
(37, 'Horizontal laser check (EMC)'),
(38, 'Shuttle sensors check'),
(39, 'Thermic motor protection check'),
(40, 'Horizontal laser out of tolerance'),
...
(66, ''),
(67, ''),
(68, 'Flap motor time out'),
(69, 'Flap motor limitswitches'),
(70, ''),
(71, ''),
(72, ''),
(73, 'Door motor time out'),
(74, 'Door limitswitches'),
(75, ''),
(76, 'Ceiling motor time out'),
(77, 'Ceiling position limitswitches'),
(78, 'Ceiling locking pin motor time out'),
(79, 'Ceiling locking pin limitswitches'),
(80, 'Thermic motor protection check ( ceiling )'),
(81, ''),
(82, ''),
(83, ''),
(84, ''),
